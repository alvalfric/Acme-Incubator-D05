...
@Service
public class AuthenticatedEntrepeneurCreateService implements AbstractCreateService<Authenticated, Entrepeneur> {
	...
	@Override
	public Entrepeneur instantiate(final Request<Entrepeneur> request) {
		assert request != null;
	...
	@Override
	public void create(final Request<Entrepeneur> request, final Entrepeneur entity) {
		assert request != null;
		assert entity != null;
