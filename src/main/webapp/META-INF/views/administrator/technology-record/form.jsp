...
<acme:form>
	...
	<jstl:choose>
		<jstl:when test="${sourceType == 'Closed-Source'}">
			...
			<acme:form-option code="administrator.technology-record.form.label.closedSource" value="Closed-Source" selected="true"/>
		</jstl:when>
		<jstl:otherwise>
			<acme:form-option code="administrator.technology-record.form.label.openSource" value="Open-Source" selected="true"/>
